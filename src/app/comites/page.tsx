...
export default function ComitesPage() {
  ...
  return (
    <div className="min-h-screen bg-white transition-colors duration-300 dark:bg-[#0B1E2D]">
      ...
      <div className="relative mx-auto mt-8 md:mt-10 max-w-[42rem]">
        {/* Mobile List Layout */}
        <div className="flex flex-col gap-[12px] md:hidden">
          {committees.map((committee, index) => (
            <button
              ...
              className="flex w-full min-h-[120px] bg-[#1c3a5e] dark:bg-[#0d1b2e] border border-white/10 dark:border-white/10 rounded-lg overflow-hidden text-left shadow-sm cursor-pointer"
            >
            ...
            <div key={rowIndex} className="grid grid-cols-3 gap-8 lg:gap-10">
              {row.map((committee, index) => (
                <button
                  ...
                  type="button"
                  onClick={() => openModal(committee)}
                  className="group relative block aspect-square w-full cursor-pointer overflow-hidden rounded-2xl text-left transition-all duration-500 ease-out"
                >
                  <div
